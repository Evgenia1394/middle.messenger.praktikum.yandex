...
export const chatPageTpl = `
       <div class="chatPage">
        <div class="chatPage__left">
           <div class="chatPage__search">
               <div class="chatPage__title">
               Профиль >
               </div>
               {{{greyInput}}}
           </div>
           <div class="chatPage__messages">
                {{{chatList}}}
           </div>
           </div>
           
        <div class="chatPage__right">
            <div class="chatPage__dialog-header">
                <div class="chatPage__dialog-header-title-wrapper">
                    <div class="chatPage__dialog-header-icon"></div>
                    <div class="chatPage__dialog-header-text">Иван</div>
                </div>
                <div>
            ...
            <div class="chatPage__dialog">
            </div>
            
            <div class="chatPage__dialog-sending">
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M9.70068 16.014L17.2768 8.43781L18.2196 9.38062L10.6435 16.9568L9.70068 16.014Z" fill="#999999"/>
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M17.5574 23.8706L25.1335 16.2945L26.0763 17.2373L18.5002 24.8134L17.5574 23.8706Z" fill="#999999"/>
                <path fill-rule="evenodd" clip-rule="evenodd" d="M17.5574 23.8709C14.9423 26.486 10.7118 26.4954 8.10831 23.8919C5.50482 21.2884 5.51424 17.0579 8.12936 14.4428L7.18655 13.5C4.04841 16.6381 4.0371 21.7148 7.16129 24.839C10.2855 27.9632 15.3621 27.9519 18.5003 24.8137L17.5574 23.8709Z" fill="#999999"/>
                ...
                <div class="chatPage__message-input-wrapper">
                    {{{messageInput}}}
                </div>
                {{{arrowButton}}}
            </div>

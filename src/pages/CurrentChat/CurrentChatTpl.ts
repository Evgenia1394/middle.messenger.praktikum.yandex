...
export const currentChatTpl = `
            ...
            <div class="chat-page__dialog-header">
                <div class="chat-page__dialog-header-title-wrapper">
                    <div class="chat-page__dialog-header-icon"></div>
                    <div class="chat-page__dialog-header-text">{{name}}{{id}}</div>
                </div>
                <div>
                        {{{addNewUserToChatBtn}}}
            ...
            <div class="chat-page__dialog">
            {{{messages}}}
            </div>
            <div class="chat-page__dialog-sending">
                ...
                <div class="chat-page__message-input-wrapper">
                    {{{messageInput}}}
                </div>
                {{{arrowButton}}}
            </div>
